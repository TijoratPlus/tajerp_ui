  ...
  return (
    <div className={cn("flex flex-col", className)}>
      <div
        role="tablist"
        className={cn(
          "flex shrink-0 items-center gap-1 border-b border-hairline px-3 sm:px-6",
          listClassName,
        )}
      >
        {tabs.map((tab, i) => {
          ...
          return (
            <button
              ...
              onClick={() => select(i)}
              className={cn(
                "inline-flex items-center gap-2 border-b-2 px-3 py-3 text-[13.5px] font-semibold transition-colors duration-150 outline-none -mb-px cursor-pointer",
                on
