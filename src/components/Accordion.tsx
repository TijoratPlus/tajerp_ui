  ...
  return (
    <AccordionPrimitive.Header className="flex">
      <AccordionPrimitive.Trigger
        ...
        className={cn(
          "flex flex-1 items-center justify-between gap-3 py-4 text-left text-[14px] font-semibold text-ink-1 outline-none transition-colors",
...
function AccordionContent({
  ...
  return (
    <AccordionPrimitive.Content
      ...
      className="overflow-hidden text-[13.5px] text-ink-2 data-[state=closed]:animate-accordion-up data-[state=open]:animate-accordion-down"
      {...props}
    >
